...
export const VideosManager = ({ videos, currentForm, openForm, setCurrentForm, handleFileChange, handleFormSubmit, handleCancelForm, handleDelete }: VideosManagerProps) => {
  const videoFields = [
  ...
  // Function to convert YouTube URL to watch URL
